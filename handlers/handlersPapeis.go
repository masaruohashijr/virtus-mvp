...
func ListDesignarPapeisHandler(w http.ResponseWriter, r *http.Request) {
	log.Println("List Designar Papeis Handler")
	if sec.IsAuthenticated(w, r) {
		...
		tmpl.ExecuteTemplate(w, "Main-Entidades-Designar-Papeis", page)
	} else {
...
func UpdateDesignarPapeisHandler(w http.ResponseWriter, r *http.Request) {
	log.Println("Update Designar Papeis Handler")
	log.Println("--------------")
...
func DesignarPapeisHandler(w http.ResponseWriter, r *http.Request) {
	log.Println("Designar Papéis Handler")
	if sec.IsAuthenticated(w, r) {
		currentUser := GetUserInCookie(w, r)
