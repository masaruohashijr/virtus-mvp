...
func createUniqueKey() {
	...
	db.Exec(" ALTER TABLE ONLY produtos_planos" +
...
func createPKey() {
	...
	db.Exec("ALTER TABLE ONLY anotacoes ADD CONSTRAINT anotacoes_pkey PRIMARY KEY (id)")
	db.Exec("ALTER TABLE ONLY anotacoes_radares ADD CONSTRAINT anotacoes_radares_pkey PRIMARY KEY (id)")
	db.Exec("ALTER TABLE ONLY chamados ADD CONSTRAINT chamados_pkey PRIMARY KEY (id)")
	db.Exec("ALTER TABLE ONLY chamados_versoes ADD CONSTRAINT chamados_versoes_pkey PRIMARY KEY (id)")
	...
	db.Exec("ALTER TABLE ONLY produtos_pilares_historicos ADD CONSTRAINT produtos_pilares_historicos_pkey PRIMARY KEY (id)")
	db.Exec("ALTER TABLE ONLY produtos_componentes_historicos ADD CONSTRAINT produtos_componentes_historicos_pkey PRIMARY KEY (id)")
	db.Exec("ALTER TABLE ONLY produtos_elementos_historicos ADD CONSTRAINT produtos_elementos_historicos_pkey PRIMARY KEY (id)")
	db.Exec("ALTER TABLE ONLY produtos_itens_historicos ADD CONSTRAINT produtos_itens_historicos_pkey PRIMARY KEY (id)")
	db.Exec("ALTER TABLE ONLY radares ADD CONSTRAINT radares_pkey PRIMARY KEY (id)")
	...
	db.Exec("ALTER TABLE ONLY versoes ADD CONSTRAINT versoes_pkey PRIMARY KEY (id)")
